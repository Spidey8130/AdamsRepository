...
public class Drive extends TimedRobot {
    ...
    public CANSparkMax lFMotor = new CANSparkMax(3, CANSparkMaxLowLevel.MotorType.kBrushless);
    public CANSparkMax lBMotor = new CANSparkMax(1, CANSparkMaxLowLevel.MotorType.kBrushless);
